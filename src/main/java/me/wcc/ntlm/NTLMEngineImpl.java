 ...
 *
 * <strong>Announcement: modified from apache HttpClient</strong>
 *
 * @since 4.1
 */
...
final class NTLMEngineImpl implements NTLMEngine {
     ...
     * @throws NTLMEngineException If {@link #RC4(byte[], byte[])} fails.
     */
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(final String messageBody, final int expectedType) throws NTLMEngineException {
            ...
            messageContents = Base64.getDecoder().decode(EncodingUtils.getBytes(messageBody,
                    DEFAULT_CHARSET));
